...
// we import the generateCourse , getCourses , getCourseDetails controller function from the course.controller.js file, which will handle the logic for generating a course based on the input text
import { 
    generateCourse , 
    getCourses,
    getCourseDetails, 
